...
abstract class AppLocalizations {
  ...
  /// No description provided for @cycleWork.
  ///
  /// In en, this message translates to:
  /// **'WORK'**
  String get cycleWork;

  /// No description provided for @cycleShortBreak.
  ///
  /// In en, this message translates to:
  /// **'SHORT BREAK'**
  String get cycleShortBreak;

  /// No description provided for @cycleLongBreak.
  ///
  /// In en, this message translates to:
  /// **'LONG BREAK'**
  String get cycleLongBreak;
